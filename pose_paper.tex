...
\label{sec:problem}
(I don't know where to put this.. hard to fit in the intro, but clunky in its own section)
...
\subsubsection{Data Gathering with flag\_data}
...
During each arc, the // manipulator will perform (several different motions), (where the reaction of the base to the manipulator movement will be measured.

\subsubsection{Pose tracking with ar\_pose}
The second portion is a modified version of the ar\_pose package, a ROS wrapper for the ARToolkit libary. 
